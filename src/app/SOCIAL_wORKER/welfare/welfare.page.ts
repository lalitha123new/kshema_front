...
export class WelfarePage implements OnInit {
  ...
  task_array = [];
  wel1YesChecked:Boolean = true;
  wel2YesChecked:Boolean = false;
  wel3YesChecked:Boolean = false;
  wel4YesChecked:Boolean = false;
  wel5YesChecked:Boolean = false;
  wel6YesChecked:Boolean = false;
  wel7YesChecked:Boolean = false;
  wel8YesChecked:Boolean = false;
  wel9YesChecked:Boolean = false;
  wel10YesChecked:Boolean = false;
  wel11YesChecked:Boolean = false;
  wel12YesChecked:Boolean = false;
  wel13YesChecked:Boolean = false;
  showSpinner = false;
...
ionViewWillEnter() {
  ...
  for(var i=0;i<this.tobaccooptionsArray1new.length;i++){
    this.tobaccooptionsArray1new[i].checked = false;
  }
  for(var i=0;i<this.tobaccooptionsArray2.length;i++){
    this.tobaccooptionsArray2[i].checked = false;
  }
  for(var i=0;i<this.tobaccooptionsArray2new.length;i++){
    this.tobaccooptionsArray2new[i].checked = false;
  }
  ...
  for(var i=0;i<this.tobaccooptionsArray4new.length;i++){
    this.tobaccooptionsArray4new[i].checked = false;
  }
  ...
  for(var i=0;i<this.YesNoOtherOptions.length;i++){
    this.YesNoOtherOptions[i].checked = false;
  }
  for(var i=0;i<this.yesNoArray2.length;i++){
    this.yesNoArray2[i].checked = false;
  }
  for(var i=0;i<this.yesNoArray3.length;i++){
    this.yesNoArray3[i].checked = false;
  }
  for(var i=0;i<this.yesNoArray4.length;i++){
    this.yesNoArray4[i].checked = false;
  }
    ...
    for(var i = 0;i<welfare_array_first.length;i++){
          ...
          if(welfare_array_first[i].task_type == 29){
            ...
            if(this.option_value9 == "Yes"){
              this.tobaccooptionsArray4new[0].checked = true;
              ...
              this.tobaccooptionsArray4new[1].checked = true;
              this.firstFormGroup.controls.welfaresubForm9.get('form9').setValue(this.option_value9);
            }else if(this.option_value9 == "Already availed"){
              this.tobaccooptionsArray4new[2].checked = true;
              this.firstFormGroup.controls.welfaresubForm9.get('form9').setValue(this.option_value9);
            }
            this.check9 = true;
...
redirectTo(x){
  ...
  //if first visit, then insert data to table else update data in the table
    ...
    if(this.task_id1 != undefined){
      if(this.firstFormGroup.controls.welfaresubForm1.get('form1_details').value){
      arr1.push(this.firstFormGroup.controls.welfaresubForm1.get('form1').value,this.firstFormGroup.controls.welfaresubForm1.get('form1_details').value)
        ...
        arr1.push(this.firstFormGroup.controls.welfaresubForm1.get('form1').value,this.det1)
    ...
    let arr2 = [];
    arr2.push(this.firstFormGroup.controls.welfaresubForm2.get('form2').value,this.det2)
    welObj2 = {
      uuid:this.task_id2,
        task_status:"pending",
      task_details:arr2,
  ...
  fourthArray.push(fourthObj2);
    ...
    if(this.task_id3 != undefined){
     if(this.firstFormGroup.controls.welfaresubForm3.get('form3_date').value != ""){
      ...
      let arr3 = [];
      arr3.push(this.firstFormGroup.controls.welfaresubForm3.get('form3').value,this.det3)
      welObj3 = {
        uuid:this.task_id3,
        task_status:"pending",
        task_details:arr3,
    ...
    if(this.firstFormGroup.controls.welfaresubForm4.get('form4_date').value != ""){
      ...
      arr4.push(this.firstFormGroup.controls.welfaresubForm4.get('form4').value,this.det4)
      welObj4 = {
        uuid:this.task_id4,
        task_status:"pending",
        task_details:arr4,
...
arr5.push(this.firstFormGroup.controls.welfaresubForm5.get('form5').value,this.firstFormGroup.controls.welfaresubForm5.get('form5_details').value)
      ...
      arr5.push(this.firstFormGroup.controls.welfaresubForm5.get('form5').value,this.det5)
      welObj5 = {
        uuid:this.task_id5,
        task_status:"pending",
        task_details:arr5,
    ...
    arr6.push(this.firstFormGroup.controls.welfaresubForm6.get('form6').value,this.firstFormGroup.controls.welfaresubForm6.get('form6_details').value)
      ...
      arr6.push(this.firstFormGroup.controls.welfaresubForm6.get('form6').value,this.det6)
    ...
    if(this.task_id7 != undefined){
     if(this.firstFormGroup.controls.welfaresubForm7.get('form7_date').value != ""){
      ...
      arr7.push(this.firstFormGroup.controls.welfaresubForm7.get('form7').value,this.det7)
  ...
  arr7.push(this.firstFormGroup.controls.welfaresubForm7.get('form7').value,this.firstFormGroup.controls.welfaresubForm7.get('form7_details').value)
    ...
    if(this.firstFormGroup.controls.welfaresubForm8.get('form8_date').value != ""){
     ...
     arr8.push(this.firstFormGroup.controls.welfaresubForm8.get('form8').value,this.det8)
   ...
   if(this.firstFormGroup.controls.welfaresubForm8.get('form8_date').value != ""){
    ...
    if(this.task_id9 != undefined){
     ...
     arr9.push(this.firstFormGroup.controls.welfaresubForm9.get('form9').value,this.det9)
    ...
    if(this.task_id10 != undefined){
     ...
     arr10.push(this.firstFormGroup.controls.welfaresubForm10.get('form10').value,this.det10)
  ...
  arr11.push(this.firstFormGroup.controls.welfaresubForm11.get('form11').value,this.firstFormGroup.controls.welfaresubForm11.get('form11_details').value)
      ...
      arr11.push(this.firstFormGroup.controls.welfaresubForm11.get('form11').value,this.det11)
    ...
    if(this.task_id12 != undefined){
     if(this.firstFormGroup.controls.welfaresubForm12.get('form12_date').value != ""){
      ...
      arr12.push(this.firstFormGroup.controls.welfaresubForm12.get('form12').value,this.det12)
...
arr13.push(this.firstFormGroup.controls.welfaresubForm13.get('form13').value,this.firstFormGroup.controls.welfaresubForm13.get('form13_details').value)
      ...
      arr13.push(this.firstFormGroup.controls.welfaresubForm13.get('form13').value,this.det13)
...
let result2 = await this.patientService.addWelfareTask(this.patient_uuid,fourthArray).then(() => {
  ...
  tobaccooptionsArray4new: tobacco_options[] = [
    {value: '1', viewValue: 'Yes',checked:false},
    {value: '2', viewValue: 'No',checked:false},
    {value: '3', viewValue: 'Already availed',checked:false}
